...
PATH = '/home/xinshu/programs/2024ccl/scorer/ChERRANT'
...
def read_cilin():
    ...
    """
    # TODO -- fix this path
    lines = open(os.path.join(PATH,"data/cilin.txt"), "r",
...
def read_confusion():
    confusion_dict = {}
    with open(os.path.join(PATH,"data/confusion_dict.txt"), "r", encoding="utf-8") as f:
        for line in f:
            li = line.rstrip('\n').split(" ")
